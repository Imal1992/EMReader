...
public class Consumer_register extends ActionBarActivity {
    ...
    Button bRegister;
    EditText etMeter_ID_List,etFirst_name,etLast_name,etEmail_address,etPassword,etAddress_no,etAddress_street,etAddress_city,etNo_Of_Meters,et_Meter_ID,etContact,etConfirmpwd;
    String  meter_id_list,Type,First_name,Last_name,Address_no,Address_Street,Address_city,Meter_ID,Email_address,Password,Confirmpwd,Contactstr,No_Of_Meterstr,Meter_IDstr;;
    int Contact,No_Of_Meters,array_index=0;
    String current_list="", Meter_ID_Arr[]=new String[10],n_o_meter_from_spinner="1"; //maximum number of  10 meter id per consumer;
    ProgressDialog progressDialog;
    private UserLoginTask mAuthTask = null;
    public static final int CONNECTION_TIMEOUT = 1000*15;
    public static final String SERVER_ADDRESS = "http://luceferdb.freeiz.com/";
    Spinner sp;
...
*/
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpPost post1 = new HttpPost(SERVER_ADDRESS + "ConsumerType.php");
            HttpPost post2 = new HttpPost(SERVER_ADDRESS + "meterID_entry.php");
