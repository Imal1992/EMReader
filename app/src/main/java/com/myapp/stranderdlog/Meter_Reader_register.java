...
public class Meter_Reader_register extends ActionBarActivity {
    ...
    Button bRegister;
    EditText etFirst_name,etLast_name,etEmail_address,etPassword,etAddress_no,etAddress_street,etAddress_city,etCovering_areas,etContact,etConfirmpwd;
    String Type,First_name,Last_name,Address_no,Address_Street,Address_city,Email_address,Password,Covering_areas,Confirmpwd,Contactstr;
    int Contact,No_Of_Meters,Meter_ID;
...
*/
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpPost post = new HttpPost(SERVER_ADDRESS + "MeterReaderType.php");
